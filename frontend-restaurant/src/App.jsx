...
function MainLayout({ children, selectedRestaurant, loadOrders }) {
  return (
    <div className="app-shell">
      <Navbar selectedRestaurant={selectedRestaurant} loadOrders={loadOrders} />
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <MainLayout selectedRestaurant={selectedRestaurant} loadOrders={loadOrders}>
                <Home
